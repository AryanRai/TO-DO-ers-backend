...
#googlesigninbtn:hover, #googlesignupbtn:hover {
  cursor: pointer;
}
...
<div id="body">
      ...
      <div class="container a-container" id="a-container">
        <form class="form" id="a-form" method="" action="">
          ...
          <div id="gSignUpWrapper">
            <span class="form__span">Sign up with:</span><br><br>
            <div id="googlesignupbtn" class="customGPlusSignIn">
      ...
      <div class="container b-container" id="b-container">
        <form class="form" id="b-form" method="" action="">
          ...
          <div id="gSignInWrapper">
            <span class="form__span">Sign in with:</span><br><br>
            <div id="googlesigninbtn" class="customGPlusSignIn" onclick="googleauth">
              <span class="icon"></span>
              <span class="buttonText">Google</span>
            </div>
          </div>
 ...
 <div id="keepcss" class="is-txr is-txl is-z200 is-gx">
 </div>
...
// For Firebase JS SDK v7.20.0 and later, measurementId is optional
    ...
    apiKey: "AIzaSyBU1brUgAnnGSk1ilGxr2rTTHcW5mOe11A",
    authDomain: "to-do-ers.firebaseapp.com",
    projectId: "to-do-ers",
    storageBucket: "to-do-ers.appspot.com",
    messagingSenderId: "266544134747",
    appId: "1:266544134747:web:2f648fa8a4419086285d7e",
    measurementId: "G-CB0WFV7GW8"
    };
